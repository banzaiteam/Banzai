...
import {SidebarBase, SidebarBaseNavigation, SidebarBaseItem, type SidebarBaseProps} from "@shared/ui";
...
const RenderDefault = (props: RenderDefaultProps) => {
    ...
    return  <SidebarBase style={{gridArea: 'sidebar'}} {...rest}>
        <SidebarBaseNavigation>
                {sidebarItemsMapped}
        </SidebarBaseNavigation>
        <SidebarBaseItem isActive={isDisabled} disabled={isDisabled} icon={<LogOutOutline stroke={'currentColor'} />} onClick={()=>alert('Some event')}>Log Out</SidebarBaseItem>
    </SidebarBase>
}
