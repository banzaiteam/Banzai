...
import s from "./EmailVerifyPage.module.scss";
...
export const EmailVerifyPage =()=> {
    ...
    return <>
        <PresentationPage title={'Email verification link expired'}
            ...
            <form onSubmit={handleSubmit(onSubmitHandler)} role="form"
                ...
                <div className={s.email_block}>
                    ...
                    <div className={s.button_wrapper}>
                        <Button disabled={isDisabled || isLoading} variant={'primary'} type={'submit'} width={'100%'} aria-label="Resend verification link for a new account">
